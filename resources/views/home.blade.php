...
@section('content')
    ...
    @section('Top Bar title')
       ...
       <ol class="breadcrumb">
           <li class="breadcrumb-item active">Welcome to GCMG Resource Admin Portal </li>
       </ol>
    @endsection 
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class=" col-lg card-box">
                    <h4 class="header-title mb-4">Media Downloads</h4>
                    <div id="chartdiv"></div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                <div class="card-box mb-0 widget-chart-two">
                                    <div class="float-right">
                                        <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                               data-fgColor="#0acf97" value="{{$category_typesApp->count()}}" data-skin="tron" data-angleOffset="180"
                                               data-readOnly=true data-thickness=".1"/>
                                    </div>
                                    <div class="widget-chart-two-content">
                                        <p class="text-muted mb-0 mt-2">Number of Categories for </p>
                                        <h3 class="">Applications</h3>
                                    </div>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                <div class="card-box mb-0 widget-chart-two">
                                    <div class="float-right">
                                        <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                               data-fgColor="#f9bc0b" value="{{$category_typesAudio->count()}}" data-skin="tron" data-angleOffset="180"
                                               data-readOnly=true data-thickness=".1"/>
                                    </div>
                                    <div class="widget-chart-two-content">
                                        <p class="text-muted mb-0 mt-2">Number of Categories for </p>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                <div class="card-box mb-0 widget-chart-two">
                                    <div class="float-right">
                                        <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                               data-fgColor="#f1556c" value="{{$category_typesbooks->count()}}" data-skin="tron" data-angleOffset="180"
                                               data-readOnly=true data-thickness=".1"/>
                                    </div>
                                    <div class="widget-chart-two-content">
                                        <p class="text-muted mb-0 mt-2">Number of Categories for </p>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                <div class="card-box mb-0 widget-chart-two">
                                    <div class="float-right">
                                        <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                               data-fgColor="#2d7bf4" value="{{$category_typesVideo->count()}}" data-skin="tron" data-angleOffset="180"
                                               data-readOnly=true data-thickness=".1"/>
                                    </div>
                                    <div class="widget-chart-two-content">
                                        <p class="text-muted mb-0 mt-2">Number of Categories for </p>
                    ...
                    <div class="card-box">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-centered m-0">
                                ...
                                <tbody>
                                <tbody>
                                @foreach($catlimit as $category)    
                                <tr>
                                    <td>{{$category->name}}</td>
                                    <td>{{$category->type}}</td>
                                    <td>{{$category->description}}</td>
                                    <td>
                                        <a href="{{route('categories.edit',['category' => $category->id])}}" class="btn btn-success btn-rounded waves-light waves-effect">
        ...
        ! function($) {
            ...
            FlotChart.prototype.createPlotGraph = function(selector, data1, data2, data3, labels, colors, borderColor, bgColor) {
                ...
                FlotChart.prototype.init = function() {
                    ...
                    var plabels = ["Bitcoin", "atc", "Litecoin"];
                    ...
                    var donutlabels = ["Bitcoin", "atc", "Litecoin", "Bitcoin Cash", "Cardano"];
...
@section('scripts')
    ...
    <!-- AM Charts Online Libraies -->
    <script src="https://www.amcharts.com/lib/4/core.js"></script>
    <script src="https://www.amcharts.com/lib/4/charts.js"></script>
    <script src="https://www.amcharts.com/lib/4/themes/animated.js"></script>

    <!--AM Charts Ofline Libraries -->
    <script src="{{asset('admin_assets/assets/js/amcharts.lib.4.core.js')}}"></script>
    <script src="{{asset('admin_assets/assets/js/amcharts.lib.4.charts.js')}}"></script>
    <script src="{{asset('admin_assets/assets/js/amcharts.lib.4.themes.animated.js')}}"></script>
