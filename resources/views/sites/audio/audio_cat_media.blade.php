...
@extends('layouts.site')
    ...
    @section('title')
    GCMG DIGITAL MINISTRY - AUDIO DOWNLOAD MEDIA
    @endsection
            ...
            <section class="pt100 pb80 bg-pattern-3">
                <div class="container">
                    <div class="row">  
                        ...
                        @if($media->audiosmedia->count() >= "1")
                            <div class="col-md-12 text-center section-heading mb40">  
                                <h5>Application Resource</h5>
                                <h3 class="underline-center">Dowload Audio/Music Media</h3>
                            </div> 
                        ...
                        @if($media->audiosmedia->count() == "0")
                            <div class="col-md-12 text-center section-heading mb50">
                                <h4 class="header-title m-t-0">Sorry!!! There are no media attached to this Audio/Music <span class="text-danger"> </span></h4>
