...
@extends('layouts.site')
    ...
    @section('title')
    GCMG DIGITAL MINISTRY - BOOK CATEGORY
    @endsection
                    ...
                    <div class="row">     
                        @if($categories->count() >= "1")
                            <div class="col-md-12 text-center section-heading mb40">  
                                <h5>Book Resource</h5>
                                <h3 class="underline-center">Category of Books</h3>
                            </div> 
                       
                            @foreach($categories as $category)
                                <div class="col-md-4 mb30">
                                    <a href="{{route('selectCategoryListBook',['category'=>$category->id])}}" class="a-box box-hover">
                                        <div class="box bg-white">
                                            <i class="icon-notebook size-4x highlight"></i>
                        ...
                        @if($categories->count() == "0")
                            <div class="col-md-12 text-center section-heading mb50">
                                <h4 class="header-title m-t-0">Sorry!!! There are no Categories attached to this Books Section<span class="text-danger"> </span></h4>
