...
@extends('layouts.site')
    ...
    @section('title')
    GCMG DIGITAL MINISTRY - VIDEO CATEGORY
    @endsection
                    ...
                    <div class="row">     
                        @if($categories->count() >= "1")
                            <div class="col-md-12 text-center section-heading mb40">  
                                ...
                                <h3 class="underline-center">Category of Videos</h3>
                            </div> 
                       
                            @foreach($categories as $category)
                                <div class="col-md-4 mb30">
                                    <a href="{{route('selectCategoryListVideo',['category'=>$category->id])}}" class="a-box box-hover">
                                        <div class="box bg-white">
                                            <i class="icon-video size-4x highlight"></i>
                        ...
                        @if($categories->count() == "0")
                            <div class="col-md-12 text-center section-heading mb50">
                                <h4 class="header-title m-t-0">Sorry!!! There are no Categories attached to this Video Section<span class="text-danger"> </span></h4>
