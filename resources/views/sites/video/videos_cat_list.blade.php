...
@extends('layouts.site')
    ...
    @section('title')
    GCMG DIGITAL MINISTRY - VIDEO CATEGORY LIST
    @endsection
                    ...
                    <div class="row">  
                        ...
                        @if($category->Videos->count() >= "1")
                            <div class="col-md-12 text-center section-heading mb40">  
                                ...
                                <h3 class="underline-center">List of Categorized Videos</h3>
                            </div>                         
                       
                            @foreach($category->Videos as $Video)
                                <div class="col-md-4 mb30">
                                    <a href="{{route('getCategoryMediaVideo',['category'=>$category->id, 'media'=>$Video->id])}}" class="a-box box-hover">
                                        <div class="box bg-white"> 
                                            <i class="icon-pictures size-4x highlight"></i>
                                            <div style="height: 50px">
                                                <h4><small>{{$Video->name}}</small></h4>                                   
                                            </div>
                                            <div style="height: 100px">
                                                <h4><small>Number of Media: {{$Video->Videosmedia->count()}}</small></h4>
                        ...
                        @if($category->videos->count() == "0")
                            <div class="col-md-12 text-center section-heading mb50">
                                <h4 class="header-title m-t-0">Sorry!!! There are no List of Categorized Videos<span class="text-danger"> </span></h4>
