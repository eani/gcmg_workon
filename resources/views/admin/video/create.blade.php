                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Create new Video file</h4>
                                    <p class="text-muted font-14 m-b-20">
                                        This table is to help you add new Video to the Resource Contents..
                                    </p>


                                    <form id="form1" action="{{route('videos.store')}}" role="form" method="POST">
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label>Name of the Video <span class="text-danger"> *</span></label>
                                            <input name="name" value="{{old('name')}}"  parsley-trigger="change" placeholder="Video Name here..." class="form-control" id="userName" type="text">
                                    ...
                                    <h4 class="header-title m-t-0">Dropzone for the Video Uploads <span class="text-danger"> </span></h4>
